    ...
    if collection is not None:
        ...
        collec_obj = {
            ...
            "assessments": [
                ...
                f"https://w3id.org/fair-enough/metrics/tests/a1-access-protocol",
                f"https://w3id.org/fair-enough/metrics/tests/f1-unique-persistent-id",
                f"https://w3id.org/fair-enough/metrics/tests/f2-machine-readable-metadata",
                f"https://w3id.org/fair-enough/metrics/tests/f3-id-in-metadata",
                f"https://w3id.org/fair-enough/metrics/tests/i1-knowledge-representation",
                f"https://w3id.org/fair-enough/metrics/tests/i2-fair-vocabularies",
                f"https://w3id.org/fair-enough/metrics/tests/r1-accessible-license",
